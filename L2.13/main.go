...
// -f "fields" — указание номеров полей (колонок), которые нужно вывести.
// Номера через запятую, можно диапазоны.
...
// Условия:
// Программа должна корректно парсить аргументы,
// поддерживать различные комбинации (например,
// несколько отдельных полей и диапазонов), учитывать,
