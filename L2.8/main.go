...
// Программа должна выводить текущее время,
// полученное через NTP (Network Time Protocol).

// Необходимо обрабатывать ошибки библиотеки:
// в случае ошибки вывести её текст в STDERR и вернуть ненулевой код выхода.

// Код должен проходить проверки (vet и golint),
// т.е. быть написан идиоматически корректно.

// Дедлайн — 30 янв, 02:59
// Решение:
